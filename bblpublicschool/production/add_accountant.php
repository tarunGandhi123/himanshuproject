     ...
     <div class="row">
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form id="accountant_registration"  method="POST" action=""  enctype="multipart/form-data" data-parsley-validate>
       ...
       <image id="profile_pic"  style="cursor: pointer;" />
                ...
                <input id="v_accountant_photograph" type="file" name="v_accountant_photograph" id="v_accountant_photograph" required>

              <label for="fullname"> Name * :</label>
              <input type="text" id="v_accountant_name" class="form-control" name="v_accountant_name" required />

              <label for="email">Email * :</label>
              <input type="email" id="v_accountant_email" class="form-control" name="v_accountant_email" data-parsley-trigger="change" required />
            ...
            <br/>
            <input type="submit" name="add_accountant_db" id="add_accountant_db" value="submit">
