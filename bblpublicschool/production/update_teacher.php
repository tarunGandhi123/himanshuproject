...
if(isset($_GET["id"]) && !empty($_GET["id"])){
  $id = $_GET["id"];
 $select_teacher_data = "select * from tbl_teacher_record where i_sno=$id";
$exec_select_teacher_data = mysqli_query($db,$select_teacher_data);
$res_exec_select_teacher_data = mysqli_fetch_array($exec_select_teacher_data);
$v_teacher_name= $res_exec_select_teacher_data['v_teacher_name'];
$v_teacher_photograph =$res_exec_select_teacher_data['v_teacher_photograph'];
$v_teacher_email= $res_exec_select_teacher_data['v_teacher_email'];
$v_gender =$res_exec_select_teacher_data['v_gender'];
$v_highest_qualifications= $res_exec_select_teacher_data['v_highest_qualifications'];
$v_salary =$res_exec_select_teacher_data['v_salary'];
$v_phone= $res_exec_select_teacher_data['v_phone'];
 $v_address =$res_exec_select_teacher_data['v_address'];
$v_account_no =$res_exec_select_teacher_data['v_account_no'];
$v_bank_name= $res_exec_select_teacher_data['v_bank_name'];
$v_ifsc_code =$res_exec_select_teacher_data['v_ifsc_code'];
}
else{
echo "Data no Found";
}
if(isset($_POST['update']))
{
  ...
  // Check extension
    if( in_array($imageFileType,$extensions_arr) ){
      ...
      // Upload file
    move_uploaded_file($_FILES['v_teacher_photograph']['tmp_name'],$targetDir.$fileName);
  }

    echo  $v_teacher_photograph=basename($_FILES["v_teacher_photograph"]["name"],".jpg");
      ...
      $V_teacher_id1_md5=md5($V_teacher_id1);
      if(!empty($v_teacher_photograph)){
        echo $update_teacher_record = "update tbl_teacher_record  set v_teacher_id='$V_teacher_id1', v_teacher_photograph ='$target_file',
        v_teacher_name = '$V_teacher_name1',
        v_teacher_email = '$V_teacher_email1',
        v_gender = '$V_gender1',
        v_salary = '$V_salary1',
        v_phone='$V_phone1',
        ...
        ";
        $exec_update_teacher_record= mysqli_query($db,$update_teacher_record);
        if($exec_update_teacher_record == 1){
        echo "<script>alert('Successfully update')</script>";

      echo "<script>window.location.replace('manage_teachers.php');</script>";
...
echo "<script>alert('Cannot Update')</script>";
  ...
  echo  $update_teacher_record = "update tbl_teacher_record  set v_teacher_id='$V_teacher_id1',
  v_teacher_name = '$V_teacher_name1',
  v_teacher_email = '$V_teacher_email1',
  v_gender = '$V_gender1',
  v_salary = '$V_salary1',
...
<form id="teacher_registration_update"  method="POST" action=""  enctype="multipart/form-data" data-parsley-validate>
...
<img src=" <?php echo $v_teacher_photograph;?>" style="width:150px;height:200px;">
<image id="profile_pic"  style="cursor: pointer;" />
</div>
    <input id="v_teacher_photograph" type="file" name="v_teacher_photograph" id="v_teacher_photograph" >

  <label for="fullname"> Name * :</label>
  <input type="text" id="v_teacher_name" class="form-control" name="v_teacher_name" value="<?php echo $v_teacher_name;?>" required />

  <label for="email">Email * :</label>
  <input type="email" id="v_teacher_email" class="form-control" name="v_teacher_email"value="<?php echo $v_teacher_email;?>" data-parsley-trigger="change" required />
